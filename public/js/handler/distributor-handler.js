...
var FormValidation = function () {
    ...
    // Master Validation
    var distributorValidation = function() {
                        ...
                        success: function (data) {
                            ...
                            swal({
                                ...
                                function(){
                                    ...
                                    $('#distributorTable').DataTable().search('').draw();
                                    $('#distributorTable').DataTable().ajax.reload();

                                    $('#exportAll').removeAttr('disabled');
                                    $('#export').removeAttr('disabled');

                                    $('#distributor').modal('hide');
                                }
                            )
...
$(document.body).on("change",".select2select",function(){
    ...
    select2Change($(this), $('#form_form_distributor'));

});

// Reset Validation
function resetValidation(){
    $('#form_distributor').each(function(){
    ...
    $('.alert-danger', $('#form_distributor')).hide();
    $('.alert-success', $('#form_distributor')).hide();
}