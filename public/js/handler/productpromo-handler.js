                        ...
                        success: function (data) {
                            ...
                            swal({
                                ...
                                function(){
                                    ...
                                    $('#productpromoTable').DataTable().search('').draw();
                                    $('#productpromoTable').DataTable().ajax.reload();

                                    $('#productpromo').modal('hide');
                                }
                            )
...
$(document.body).on("change",".select2select",function(){
    ...
    select2Change($(this), $('#form_productpromo'));

});

// Reset Validation
function resetValidation(){
    $('#form_productpromo').each(function(){
    ...
    $('.alert-danger', $('#form_productpromo')).hide();
    $('.alert-success', $('#form_productpromo')).hide();
}