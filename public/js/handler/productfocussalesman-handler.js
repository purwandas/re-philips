...
var FormValidation = function () {
    ...
    // Master Validation
    var productFocusValidation = function() {

            var form = $('#form_productfocussalesman');
                        ...
                        success: function (data) {
                            ...
                            swal({
                                ...
                                function(){
                                    ...
                                    $('#productfocussalesmanTable').DataTable().search('').draw();
                                    $('#productfocussalesmanTable').DataTable().ajax.reload();

                                    $('#productfocussalesman').modal('hide');
                                }
                            )
...
$(document.body).on("change",".select2select",function(){
    ...
    select2Change($(this), $('#form_productfocussalesman'));

});

// Reset Validation
function resetValidation(){
    $('#form_productfocussalesman').each(function(){
    ...
    $('.alert-danger', $('#form_productfocussalesman')).hide();
    $('.alert-success', $('#form_productfocussalesman')).hide();
}