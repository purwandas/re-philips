...
var FormValidation = function () {
    ...
    // Master Validation
    var subChannelValidation = function() {

            var form = $('#form_subchannel');
                        ...
                        success: function (data) {
                            ...
                            swal({
                                ...
                                function(){
                                    ...
                                    $('#subChannelTable').DataTable().search('').draw();
...
$(document.body).on("change",".select2select",function(){
    ...
    select2Change($(this), $('#form_subchannel'));

});

// Reset Validation
function resetValidation(){
    $('#form_subchannel').each(function(){
    ...
    $('.alert-danger', $('#form_subchannel')).hide();
    $('.alert-success', $('#form_subchannel')).hide();
}