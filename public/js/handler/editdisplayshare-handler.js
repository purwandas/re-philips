...
var FormValidation = function () {
    ...
    var channelValidation = function() {
            ...
            var form = $('#form_editdisplayshare');
                        ...
                        success: function (data) {
                            ...
                            swal({
                                ...
                                function(){
                                    ...
                                    $('#displayShareTable').DataTable().search('').draw();
                                    $('#displayShareTable').DataTable().ajax.reload();

                                    $('#editdisplayshare').modal('hide');
                                }
                            )
...
function resetValidation(){
    $('#form_editdisplayshare').each(function(){
    ...
    $('.alert-danger', $('#form_editdisplayshare')).hide();
    $('.alert-success', $('#form_editdisplayshare')).hide();
}