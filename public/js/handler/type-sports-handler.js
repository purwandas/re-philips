                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if(data.invalid != ''){
                                ...
                                if(data.invalid == 'gender_type_athlete'){
                                    swal("Warning", "Can't perform action change gender. There are not match gender in athlete data. Please check the data first.", "warning");
                                    return;
                                }

                                if(data.invalid == 'gender_type'){
                                    swal("Warning", "Can't perform action change gender. There are not match gender in match entries data. Please check the data first.", "warning");
                                    return;
                                }
                            }
