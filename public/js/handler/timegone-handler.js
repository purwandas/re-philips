                        ...
                        success: function (data) {
                            ...
                            swal({
                                ...
                                function(){
                                    ...
                                    $('#timegoneTable').DataTable().search('').draw();
...
$(document.body).on("change",".select2select",function(){
    ...
    select2Change($(this), $('#form_timegone'));

});

// Reset Validation
function resetValidation(){
    $('#form_timegone').each(function(){
    ...
    $('.alert-danger', $('#form_timegone')).hide();
    $('.alert-success', $('#form_timegone')).hide();
}