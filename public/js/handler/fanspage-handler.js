...
var FormValidation = function () {
    ...
    // Master Validation
    var fanspageValidation = function() {

            var form = $('#form_fanspage');
                        ...
                        success: function (data) {
                            ...
                            swal({
                                ...
                                function(){
                                    ...
                                    $('#fanspageTable').DataTable().search('').draw();
                                    $('#fanspageTable').DataTable().ajax.reload();
...
$(document.body).on("change",".select2select",function(){
    ...
    select2Change($(this), $('#form_form_fanspage'));

});

// Reset Validation
function resetValidation(){
    $('#form_fanspage').each(function(){
    ...
    $('.alert-danger', $('#form_fanspage')).hide();
    $('.alert-success', $('#form_fanspage')).hide();
}