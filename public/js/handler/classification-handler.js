...
var FormValidation = function () {
    ...
    // Master Validation
    var classificationValidation = function() {

            var form = $('#form_classification');
            ...
            form.validate({
                ...
                messages:{
                    classification:{
                        required: "Please input Classification!"
                    }
                },
                        ...
                        success: function (data) {                            
                            ...
                            swal({
                                ...
                                function(){
                                    ...
                                    $('#classificationTable').DataTable().search('').draw();
                                    $('#classificationTable').DataTable().ajax.reload();
...
$(document.body).on("change",".select2select",function(){
    ...
    select2Change($(this), $('#form_classification'));

});

// Reset Validation
function resetValidation(){
    $('#form_classification').each(function(){
    ...
    $('.alert-danger', $('#form_classification')).hide();
    $('.alert-success', $('#form_classification')).hide();
}