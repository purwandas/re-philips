...
var FormValidation = function () {
    ...
    var channelValidation = function() {
            ...
            var form = $('#form_editposmactivity');
                        ...
                        success: function (data) {
                            ...
                            swal({
                                ...
                                function(){
                                    ...
                                    $('#posmActivityTable').DataTable().search('').draw();
                                    $('#posmActivityTable').DataTable().ajax.reload();

                                    $('#editposmactivity').modal('hide');
                                }
                            )
...
function resetValidation(){
    $('#form_editposmactivity').each(function(){
    ...
    $('.alert-danger', $('#form_editposmactivity')).hide();
    $('.alert-success', $('#form_editposmactivity')).hide();
}