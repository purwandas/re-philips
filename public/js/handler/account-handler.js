                        ...
                        success: function (data) {                            
                            ...
                            swal({
                                ...
                                function(){
                                    ...
                                    $('#accountTable').DataTable().search('').draw();
...
$(document.body).on("change",".select2select",function(){
    ...
    select2Change($(this), $('#form_account'));

});

// Reset Validation
function resetValidation(){
    $('#form_account').each(function(){
    ...
    $('.alert-danger', $('#form_account')).hide();
    $('.alert-success', $('#form_account')).hide();
}