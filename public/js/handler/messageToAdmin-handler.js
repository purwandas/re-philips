...
var FormValidation = function () {
    ...
    // Master Validation
    var messageToAdminValidation = function() {

            var form = $('#form_messageToAdmin');
...
function resetValidation(){
    $('#form_messageToAdmin').each(function(){
    ...
    $('.alert-danger', $('#form_messageToAdmin')).hide();
    $('.alert-success', $('#form_messageToAdmin')).hide();
}