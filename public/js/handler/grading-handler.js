...
var FormValidation = function () {
    ...
    // Master Validation
    var gradingValidation = function() {

            var form = $('#form_grading');
                        ...
                        success: function (data) {                            
                            ...
                            swal({
                                ...
                                function(){
                                    ...
                                    $('#gradingTable').DataTable().search('').draw();
                                    $('#gradingTable').DataTable().ajax.reload();
...
$(document.body).on("change",".select2select",function(){
    ...
    select2Change($(this), $('#form_grading'));

});

// Reset Validation
function resetValidation(){
    $('#form_grading').each(function(){
    ...
    $('.alert-danger', $('#form_grading')).hide();
    $('.alert-success', $('#form_grading')).hide();
}