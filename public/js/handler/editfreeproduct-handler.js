                        ...
                        success: function (data) {
                            ...
                            swal({
                                ...
                                function(){
                                    ...
                                    $('#freeProductTable').DataTable().search('').draw();
                                    $('#freeProductTable').DataTable().ajax.reload();

                                    $('#editfreeproduct').modal('hide');
                                }
                            )
...
function resetValidation(){
    $('#form_editfreeproduct').each(function(){
    ...
    $('.alert-danger', $('#form_editfreeproduct')).hide();
    $('.alert-success', $('#form_editfreeproduct')).hide();
}