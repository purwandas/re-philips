...
var FormValidation = function () {
    ...
    // Master Validation
    var groupProductValidation = function() {

            var form = $('#form_groupproduct');
                        ...
                        success: function (data) {
                            ...
                            swal({
                                ...
                                function(){
                                    ...
                                    $('#groupProductTable').DataTable().search('').draw();
                                    $('#groupProductTable').DataTable().ajax.reload();

                                    $('#groupproduct').modal('hide');
                                }
                            )
...
$(document.body).on("change",".select2select",function(){
    ...
    select2Change($(this), $('#form_groupproduct'));

});

// Reset Validation
function resetValidation(){
    $('#form_groupproduct').each(function(){
    ...
    $('.alert-danger', $('#form_groupproduct')).hide();
    $('.alert-success', $('#form_groupproduct')).hide();
}