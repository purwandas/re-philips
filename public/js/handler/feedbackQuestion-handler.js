...
var FormValidation = function () {
    ...
    // Master Validation
    var feedbackQuestionValidation = function() {

            var form = $('#form_feedbackQuestion');
                        ...
                        success: function (data) {
                            ...
                            swal({
                                ...
                                function(){
                                    ...
                                    $('#feedbackQuestionTable').DataTable().search('').draw();
                                    $('#feedbackQuestionTable').DataTable().ajax.reload();
...
$(document.body).on("change",".select2select",function(){
    ...
    select2Change($(this), $('#form_form_feedbackQuestion'));

});

// Reset Validation
function resetValidation(){
    $('#form_feedbackQuestion').each(function(){
    ...
    $('.alert-danger', $('#form_feedbackQuestion')).hide();
    $('.alert-success', $('#form_feedbackQuestion')).hide();
}