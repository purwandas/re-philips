...
var FormValidation = function () {
    ...
    // Master Validation
    var districtValidation = function() {

            var form = $('#form_resign');
            ...
            form.validate({
                ...
                submitHandler: function (form) {
                    ...
                    swal({
                        title: "Are you sure?",
                        text: "You can check resigned employee form Employee Join Back Menu.",
                        type: "warning",
                        showCancelButton: true,
                        confirmButtonClass: "btn-danger",
                        confirmButtonText: "Yes, confirm resign",
                        ...
                        if (isConfirm) {
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    swal({
                                    title: "Resigned!",
                                    text: "Employee has been resigned.",
                                    type: 'success'
                                        },
                                        function(){
                            ...
                            swal("Cancelled", "Cancelled Resign.", "success");
                        }
                    });
...
$(document.body).on("change",".select2select",function(){
    ...
    select2Change($(this), $('#form_resign'));

});

// Reset Validation
function resetValidation(){
    $('#form_resign').each(function(){
    ...
    $('.alert-danger', $('#form_resign')).hide();
    $('.alert-success', $('#form_resign')).hide();
}