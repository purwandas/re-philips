...
var FormValidation = function () {
    ...
    // Master Validation
    var groupCompetitorValidation = function() {

            var form = $('#form_groupcompetitor');
...
$(document.body).on("change",".select2select",function(){
    ...
    select2Change($(this), $('#form_groupcompetitor'));

});

// Reset Validation
function resetValidation(){
    $('#form_groupcompetitor').each(function(){
    ...
    $('.alert-danger', $('#form_groupcompetitor')).hide();
    $('.alert-success', $('#form_groupcompetitor')).hide();
}