                        ...
                        success: function (data) {
                            ...
                            swal({
                                ...
                                function(){
                                    ...
                                    $('#sohTable').DataTable().search('').draw();
                                    $('#sohTable').DataTable().ajax.reload();
...
function resetValidation(){
    ...
    $('.alert-danger', $('#form_editsoh')).hide();
    $('.alert-success', $('#form_editsoh')).hide();
}