    ...
    var productFocusValidation = function() {
            ...
            form.validate({
                ...
                messages:{
                    ...
                    type:{
                        required: "Please select Product Focus Type!"
                    },
                },
...
$(document.body).on("change",".select2select",function(){
    ...
    select2Change($(this), $('#form_productfocus'));

});

// Reset Validation
function resetValidation(){
    $('#form_productfocus').each(function(){
    ...
    $('.alert-danger', $('#form_productfocus')).hide();
    $('.alert-success', $('#form_productfocus')).hide();
}