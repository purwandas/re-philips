                        ...
                        success: function (data) {
                            ...
                            swal({
                                ...
                                function(){
                                    ...
                                    $('#tbatTable').DataTable().search('').draw();
                                    $('#tbatTable').DataTable().ajax.reload();
...
function resetValidation(){
    ...
    $('.alert-danger', $('#form_edittbat')).hide();
    $('.alert-success', $('#form_edittbat')).hide();
}