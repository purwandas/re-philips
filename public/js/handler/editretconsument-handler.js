...
var FormValidation = function () {
    ...
    var channelValidation = function() {
            ...
            var form = $('#form_editretconsument');
                        ...
                        success: function (data) {
                            ...
                            swal({
                                ...
                                function(){
                                    ...
                                    $('#retConsumentTable').DataTable().search('').draw();
                                    $('#retConsumentTable').DataTable().ajax.reload();

                                    $('#editretconsument').modal('hide');
                                }
                            )
...
function resetValidation(){
    $('#form_editretconsument').each(function(){
    ...
    $('.alert-danger', $('#form_editretconsument')).hide();
    $('.alert-success', $('#form_editretconsument')).hide();
}