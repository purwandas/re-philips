...
class CreateSummarySohsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('summary_sohs', function (Blueprint $table) {
            $table->increments('id');
            $table->string('soh_detail_id');
    ...
    {
        Schema::dropIfExists('summary_sohs');
    }
}
