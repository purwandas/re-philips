...
class CreateSummaryFreeProductTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('summary_free_products', function (Blueprint $table) {
            $table->increments('id');
            $table->string('freeproduct_detail_id');
    ...
    {
        Schema::dropIfExists('summary_free_products');
    }
}
