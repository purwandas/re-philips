...
class CreateSummarySellOutsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('summary_sell_outs', function (Blueprint $table) {
            $table->increments('id');
            $table->string('sellout_detail_id');
    ...
    {
        Schema::dropIfExists('summary_sell_outs');
    }
}
