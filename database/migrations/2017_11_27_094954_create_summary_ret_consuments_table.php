...
class CreateSummaryRetConsumentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('summary_ret_consuments', function (Blueprint $table) {
            $table->increments('id');
            $table->string('retconsument_detail_id');
    ...
    {
        Schema::dropIfExists('summary_ret_consuments');
    }
}
