...
class CreateSummarySosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('summary_sos', function (Blueprint $table) {
            $table->increments('id');
            $table->string('sos_detail_id');
    ...
    {
        Schema::dropIfExists('summary_sos');
    }
}
