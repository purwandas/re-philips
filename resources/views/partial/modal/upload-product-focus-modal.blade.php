<!-- BEGIN MODAL POPUP -->
<div id="upload-product-focus" class="modal container fade" tabindex="false" data-width="760" role="dialog" data-backdrop="static">
  ...
  <div id="loading_element">
    ...
    <div class="modal-body" style="margin-bottom: 30px;margin-left: 30px;margin-right: 30px;">
        ...
        <form id="form_upload" class="form-horizontal" action="{{ url('import-product-focus') }}" method="POST">                
                    {{ csrf_field() }}
                    @if (!empty($data))
                      {{ method_field('PATCH') }}
                    @endif
                    <div class="form-body">
                        ...
                        <div class="form-group">
                          <label class="col-sm-3 control-label">Current Product Focus</label>
                          <div class="col-sm-8">
