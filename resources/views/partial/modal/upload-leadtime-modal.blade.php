<!-- BEGIN MODAL POPUP -->
<div id="upload-leadtime" class="modal container fade" tabindex="false" data-width="760" role="dialog" data-backdrop="static">

  <div id="loading_element">

    <div class="modal-header" style="margin-top: 30px;margin-left: 30px;margin-right: 30px;">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
        <h4 class="modal-title"><b>UPLOAD EXCEL FOR LEADTIME</b> </h4>
    </div>
    <div class="modal-body" style="margin-bottom: 30px;margin-left: 30px;margin-right: 30px;">
        
        <form id="form_upload" class="form-horizontal" action="{{ url('import-leadtime') }}" method="POST">                
                    {{ csrf_field() }}
                    @if (!empty($data))
                      {{ method_field('PATCH') }}
                    @endif
                    <div class="form-body">
                        ...
                        <div class="form-group">
                          <label class="col-sm-3 control-label">Current Leadtime</label>
                          <div class="col-sm-8">
