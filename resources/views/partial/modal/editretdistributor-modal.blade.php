<!-- BEGIN MODAL POPUP -->
<div id="editretdistributor" class="modal container fade" tabindex="false" data-width="760" role="dialog">
    ...
    <div class="modal-body" style="margin-bottom: 30px;margin-left: 30px;margin-right: 30px;">
        ...
        <form id="form_editretdistributor" class="form-horizontal" action="{{ url('editretdistributor') }}" method="POST">
                    {{ csrf_field() }}
                    @if (!empty($data))
                      {{ method_field('PATCH') }}
                    @endif
