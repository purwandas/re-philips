<!-- BEGIN MODAL POPUP -->
<div id="category" class="modal container fade" tabindex="false" data-width="760" role="dialog">
    ...
    <div class="modal-body" style="margin-bottom: 30px;margin-left: 30px;margin-right: 30px;">
        ...
        <form id="form_category" class="form-horizontal" action="{{ url('category') }}" method="POST">                
                    {{ csrf_field() }}
                    @if (!empty($data))
                      {{ method_field('PATCH') }}
                    @endif
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                <input type="text" id="name" name="name" class="form-control" placeholder="Input Category Name" data-tooltip="true" />
                            </div>
                          </div>
                        </div>
