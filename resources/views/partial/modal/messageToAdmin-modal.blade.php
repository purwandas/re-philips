                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                <input type="text" id="user" name="user" class="form-control" placeholder="Input User" data-tooltip="true" readonly/>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                <input type="text" id="subject" name="subject" class="form-control" placeholder="Input Subject" data-tooltip="true" readonly/>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                <textarea id="message" name="message" class="form-control" placeholder="Input Message" data-tooltip="true" rows="10" readonly></textarea>
                            </div>
