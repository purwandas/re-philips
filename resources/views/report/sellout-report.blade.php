...
@section('header')
    ...
    <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <span class="active">Sell Out Reporting</span>
        </li>
    </ul>
@endsection
            ...
            <div class="portlet light bordered">
                ...
                <br><br>
                    ...
                    <div class="portlet-body">
                        ...
                        <table class="table table-striped table-hover table-bordered" id="sellOutReport" style="white-space: nowrap;">
                            <thead>
                            <tr>
                                <th> No. </th>
                                <th> Week </th>
...
@section('additional-scripts')
    ...
    <script>
        ...
        var url = 'datatable/selloutreport';
        var order = [ [0, 'desc'] ];
