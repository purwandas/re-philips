...
@section('additional-scripts')
    ...
    <script>
        ...
        var paramFilter = ['posmActivity', $('#posmActivity'), url, tableColumns, columnDefs, order, '#export'];
        var paramReset = [filterId, 'posmActivity', $('#posmActivity'), url, tableColumns, columnDefs, order, '#export', '#filterMonth'];
        ...
        $(document).ready(function () {
            ...
            var table = $('#posmActivity').dataTable({
                "processing": true,
                "serverSide": true,
                "ajax": {
