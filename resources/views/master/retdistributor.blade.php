...
<div class="page-head">
    ...
    <div class="page-title">
        <h1>Return Distributor
            <small>manage return distributor</small>
        </h1>
    </div>
    <!-- END PAGE TITLE -->
</div>
<ul class="page-breadcrumb breadcrumb">
    ...
    <li>
        <span class="active">Return Distributor Management</span>
    </li>
</ul>
@endsection
        ...
        <div class="portlet light bordered display-hide" id="dataContent">
            ...
            <div class="portlet-body" style="padding: 15px;">
                ...
                <div class="row">
                    ...
                    <table class="table table-striped table-hover table-bordered" id="retDistributorTable" style="white-space: nowrap;">
                        <thead>
                            <tr>
                                <th> No. </th>
                                <th> Date </th>
                ...
                @include('partial.modal.editretdistributor-modal')
...
<script src="{{ asset('js/handler/editretdistributor-handler.js') }}" type="text/javascript"></script>
...
<script>
    ...
    var url = 'datatable/editretdistributor';
    var order = [ [0, 'desc'] ];
    ...
    var paramFilter = ['retDistributorTable', $('#retDistributorTable'), url, tableColumns, columnDefs, order];//, exportButton];

    var paramReset = [filterId, 'retDistributorTable', $('#retDistributorTable'), url, tableColumns, columnDefs, order];
    ...
    $(document).ready(function () {
        ...
        // var table = $('#retDistributorTable').dataTable({
        //     "processing": true,
        //     "serverSide": true,
        //     "ajax": {
        //         url: "{{ route('datatable.editretdistributor') }}",
        //         type: 'POST',
        //     },
        //     "rowId": "id",
        //     "columns": [
        ...
        $('#retDistributorTable').on('click', 'tr td button.deleteButton', function () {
            var id = $(this).val();
    ...
    // For editing data
    $(document).on("click", ".edit-retdistributor", function () {
        ...
        var id = $(this).data('id');
        var getDataUrl = "{{ url('editretdistributor/edit/') }}";
        var postDataUrl = "{{ url('editretdistributor') }}"+"/"+id;

        // Set action url form for update
        $("#form_editretdistributor").attr("action", postDataUrl);

        // Set Patch Method
        if(!$('input[name=_method]').length){
            $("#form_editretdistributor").append("<input type='hidden' name='_method' value='PATCH'>");
        }
