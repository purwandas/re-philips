...
<div class="page-head">
    ...
    <div class="page-title">
        <h1>Return Consument
            <small>manage return consument</small>
        </h1>
    </div>
    <!-- END PAGE TITLE -->
</div>
<ul class="page-breadcrumb breadcrumb">
    ...
    <li>
        <span class="active">Return Consument Management</span>
    </li>
</ul>
@endsection
        ...
        <div class="portlet light bordered display-hide" id="dataContent">
            ...
            <div class="portlet-body" style="padding: 15px;">
                ...
                <div class="row">
                    ...
                    <table class="table table-striped table-hover table-bordered" id="retConsumentTable" style="white-space: nowrap;">
                        <thead>
                            <tr>
                                <th> No. </th>
                                <th> User Name </th>
                ...
                @include('partial.modal.editretconsument-modal')
...
<script src="{{ asset('js/handler/editretconsument-handler.js') }}" type="text/javascript"></script>
...
<script>
    ...
    var url = 'datatable/editretconsument';
    var order = [ [0, 'desc'] ];
    ...
    var paramFilter = ['retConsumentTable', $('#retConsumentTable'), url, tableColumns, columnDefs, order];//, exportButton];

    var paramReset = [filterId, 'retConsumentTable', $('#retConsumentTable'), url, tableColumns, columnDefs, order];
    ...
    $(document).ready(function () {
        ...
        // var table = $('#retConsumentTable').dataTable({
        //     "processing": true,
        //     "serverSide": true,
        //     "ajax": {
        //         url: "{{ route('datatable.editretconsument') }}",
        //         type: 'POST',
        //     },
        //     "rowId": "id",
        //     "columns": [
        ...
        $('#retConsumentTable').on('click', 'tr td button.deleteButton', function () {
            var id = $(this).val();
    ...
    // For editing data
    $(document).on("click", ".edit-retconsument", function () {
        ...
        var id = $(this).data('id');
        var getDataUrl = "{{ url('editretconsument/edit/') }}";
        var postDataUrl = "{{ url('editretconsument') }}"+"/"+id;

        // Set action url form for update
        $("#form_editretconsument").attr("action", postDataUrl);

        // Set Patch Method
        if(!$('input[name=_method]').length){
            $("#form_editretconsument").append("<input type='hidden' name='_method' value='PATCH'>");
        }
