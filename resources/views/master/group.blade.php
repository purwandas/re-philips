...
<ul class="page-breadcrumb breadcrumb">
    ...
    <li>
        <span class="active">Group Management</span>
    </li>
</ul>
@endsection
        ...
        <div class="portlet light bordered">
            ...
            <!-- MAIN CONTENT -->
                ...
                <div class="actions" style="text-align: left; padding-right: 10px;">
                    ...
                    <form id="exportAll-form" action="{{ url('util/export-group-all') }}" method="POST" style="display: none;">
                      {{ csrf_field() }}
                    </form>
                </div>
            </div>
