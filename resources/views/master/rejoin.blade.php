...
<script>
    var dataAll = {};
        ...
        var tableColumns = [
                ...
                {data: 'alasan_resign', name: 'alasan_resign'},                         
            ];
	...
	$(document).ready(function () {    	
     ...
     function initSelect2(){
             ...
             *
             */
            $('#filterNik').select2(setOptions('{{ route("data.groupPromoterRejoin") }}', 'NIK', function (params) {
            ...
            $('#filterName').select2(setOptions('{{ route("data.groupPromoterRejoin") }}', 'Name', function (params) {
                return filterData('employee', params.term);
            }, function (data, params) {
                return {
                    results: $.map(data, function (obj) {
