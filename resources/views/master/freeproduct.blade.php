...
<script>
    ...
    var url = 'datatable/editfreeproduct';
    var order = [ [0, 'desc'] ];
    ...
    var paramFilter = ['freeProductTable', $('#freeProductTable'), url, tableColumns, columnDefs, order];//, exportButton];

    var paramReset = [filterId, 'freeProductTable', $('#freeProductTable'), url, tableColumns, columnDefs, order];
