...
<div class="page-head">
    ...
    <div class="page-title">
        <h1>TBAT
            <small>manage transfer barang antar toko</small>
        </h1>
    </div>
    <!-- END PAGE TITLE -->
</div>
<ul class="page-breadcrumb breadcrumb">
    ...
    <li>
        <span class="active">TBAT Management</span>
    </li>
</ul>
@endsection
        ...
        <div class="portlet light bordered display-hide" id="dataContent">
            ...
            <div class="portlet-body" style="padding: 15px;">
                ...
                <div class="row">
                    ...
                    <table class="table table-striped table-hover table-bordered" id="tbatTable" style="white-space: nowrap;">
                        <thead>
                            <tr>
                                <th> No. </th>
                                <th> Date </th>
                ...
                @include('partial.modal.edittbat-modal')
...
<script src="{{ asset('js/handler/edittbat-handler.js') }}" type="text/javascript"></script>
...
<script>
    ...
    var paramFilter = ['tbatTable', $('#tbatTable'), url, tableColumns, columnDefs, order];//, exportButton];

    var paramReset = [filterId, 'tbatTable', $('#tbatTable'), url, tableColumns, columnDefs, order];
    ...
    $(document).ready(function () {
        ...
        $('#tbatTable').on('click', 'tr td button.deleteButton', function () {
            var id = $(this).val();
    ...
    // For editing data
    $(document).on("click", ".edit-tbat", function () {
        ...
        var id = $(this).data('id');
        var getDataUrl = "{{ url('edittbat/edit/') }}";
        var postDataUrl = "{{ url('edittbat') }}"+"/"+id;

        // Set action url form for update
        $("#form_edittbat").attr("action", postDataUrl);

        // Set Patch Method
        if(!$('input[name=_method]').length){
            $("#form_edittbat").append("<input type='hidden' name='_method' value='PATCH'>");
        }
