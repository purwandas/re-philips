...
class Store extends Model
{
     ...
     */
    protected $fillable = [
        'store_id', 'store_name_1', 'store_name_2', 'dedicate', 'longitude', 'latitude', 'channel', 'subchannel_id', 'district_id', 'user_id', 'address', 'classification', 'no_telp_toko', 'no_telp_pemilik_toko', 'kepemilikan_toko'
    ];
