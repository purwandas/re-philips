...
class VisitController extends Controller
{
    ...
    public function getVisit(){
        ...
        $visit = VisitPlan::where('visit_plans.user_id', $user->id)->where('visit_plans.date', Carbon::now()->format('Y-m-d'))
                 ...
                 ->select('stores.id', 'stores.store_id', 'stores.store_name_1', 'stores.longitude', 'stores.latitude', 'visit_plans.visit_status', 'visit_plans.id as visit_id', 'visit_plans.check_in', 'visit_plans.check_in_location', 'visit_plans.check_out', 'visit_plans.check_out_location')->get();
