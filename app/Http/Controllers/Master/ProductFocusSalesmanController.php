...
class ProductFocusSalesmanController extends Controller
{
    ...
    public function getDataWithFilters(ProductFocusSalesmanFilters $filters){
        $data = SalesmanProductFocuses::filter($filters)->join('products', 'salesman_product_focuses.product_id', '=', 'products.id')->select('salesman_product_focuses.*', 'products.name as product_name')->get();

        return $data;
    }

    public function getDataWithFiltersCheck(ProductFocusSalesmanFilters $filters){
        $data = SalesmanProductFocuses::filter($filters)->join('products', 'salesman_product_focuses.product_id', '=', 'products.id')->select('salesman_product_focuses.*', 'products.name as product_name')->limit(1)->get();
