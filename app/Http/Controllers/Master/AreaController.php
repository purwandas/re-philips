...
use App\Filters\AreaFiltersSpv;
use App\Filters\AreaFiltersDemo;
...
class AreaController extends Controller
{
    ...
    public function getDataSpvWithFilters(AreaFiltersSpv $filters){
        $userRole = Auth::user()->role->role_group;
        $userId = Auth::user()->id;       
    ...
    public function getDataDemoWithFilters(AreaFiltersDemo $filters){
        $userRole = Auth::user()->role->role_group;
        $userId = Auth::user()->id;       
