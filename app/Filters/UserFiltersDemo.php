...
class UserFiltersDemo extends QueryFilters
{
    ...
    public function byStoreDemo($value) {
        return $this->builder->whereHas('spvDemos.store', function ($query) use ($value) {
    ...
    public function byDistrictDemo($value) {
        return $this->builder->whereHas('spvDemos.store.district', function ($query) use ($value) {
    ...
    public function byAreaDemo($value) {
        return $this->builder->whereHas('spvDemos.store.district.area', function ($query) use ($value) {
    ...
    public function byRegionSpv($value) {
        return $this->builder->whereHas('spvDemos.store.district.area.region', function ($query) use ($value) {
