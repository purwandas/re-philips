...
class ReportRetConsumentFilters extends QueryFilters
{
    ...
    public function byRegion($value) {
        return $this->builder->whereHas('retConsument.store.areaapp.area.region', function ($query) use ($value) {
    ...
    public function byArea($value) {
        return $this->builder->whereHas('retConsument.store.areaapp.area', function ($query) use ($value) {
    ...
    public function byAreaApp($value) {
        return $this->builder->whereHas('retConsument.store.areaapp', function ($query) use ($value) {
    ...
    public function searchDate($value) {
       return $this->builder->whereHas('retConsument', function ($query) use ($value) {
            return $query->whereDate('ret_consuments.date', '=', Carbon::parse($value)->format('Y-m-d'));
        });
    }
    ...
    public function searchDateRange($value) {
        ...
        return $this->builder->whereHas('retConsument', function ($query) use ($value) {
            return $query->whereDate('ret_consuments.date', '>=', Carbon::parse($value[0])->format('Y-m-d'))
                ->whereDate('ret_consuments.date', '<=', Carbon::parse($value[1])->format('Y-m-d'));
        });
    }
    ...
    public function searchMonthRange($value) {
        ...
        return $this->builder->whereHas('retConsument', function ($query) use ($value) {
            return $query->whereMonth('ret_consuments.date', '>=', Carbon::parse($value[0])->format('m'))
                ->whereMonth('ret_consuments.date', '<=', Carbon::parse($value[1])->format('m'));
        });
    }
